<template>
  <div class="text-xs px-8 lg:px-16 pb-16 pt-32">
    TERMS OF SERVICE
    <br /><br />
    OVERVIEW
    <br /><br />
    This website is operated by Theerna Films and Entertainment LLP (Theerna
    Films and Entertainment). Throughout the site, the terms "we", "us" and
    "our" refer to Theerna Films and Entertainment. Theerna Films and
    Entertainment offers this website, including all information, tools and
    ...
    contributors of content. Please read these Terms of Service carefully before
    accessing or using our website. By accessing or using any part of the site,
    ...
    offer, acceptance is expressly limited to these Terms of Service. Any new
    features or tools which are added to the current store shall also be subject
    to the Terms of Service. You can review the most current version of the
    ...
    site. You may not use our products for any illegal or unauthorized purpose
    ...
    transmit any worms or viruses or any code of a destructive nature. A breach
    ...
    any comments. We may, but have no obligation to, monitor, edit or remove
    ...
    of Service. You agree that your comments will not violate any right of any
    ...
    and non-infringement. In no case shall Theerna Films and Entertainment, our
    partners, directors, officers, employees, affiliates, agents, contractors,
    ...
    <br /><br />
    You agree to indemnify, defend and hold harmless Theerna Films and
    Entertainment and our parent, subsidiaries, affiliates, partners, officers,
